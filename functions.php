...
if ( ! function_exists( 'minka_setup' ) ) :
/**
 ...
 */
function minka_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'minka' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'minka_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function minka_scripts() {
...
add_action( 'wp_enqueue_scripts', 'minka_scripts' );
